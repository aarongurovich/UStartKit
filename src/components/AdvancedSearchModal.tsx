...
const AdvancedSearchModal: React.FC<AdvancedSearchModalProps> = ({
  ...
  const inputBaseStyles =
    'w-full bg-gray-800/80 backdrop-blur-sm text-white placeholder-gray-500 border border-gray-600/50 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent transition-all text-sm';
        ...
        >
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                <label htmlFor="main-search" className={labelStyles}>
                  Starter Kit For:
                </label>
                <textarea
                  ref={textareaRef}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-3">
                ...
                <div>
                  <label htmlFor="level" className={labelStyles}>
                    Level
                  </label>
                  <div className="relative">
                    <select
                ...
                <div className="sm:col-span-3">
                  <label htmlFor="must-haves" className={labelStyles}>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className={inputStyles}
                    placeholder="e.g., A mechanical keyboard..."
                  ></textarea>
                </div>

                <div className="sm:col-span-3">
                  <label htmlFor="other" className={labelStyles}>
                    Other notes or preferences
                  </label>
                  <textarea
                    id="other"
                    value={other}
                    ...
                    rows={2}
                    className={inputStyles}
                    placeholder="e.g., I prefer sustainable products..."
                  ></textarea>
                </div>
              </div>
              ...
              <div className="flex justify-end pt-1">
                <button
                  ...
                  form={onSearchSubmit ? undefined : 'search-form'}
                  ...
                  onClick={onSearchSubmit ? handleSearchClick : onClose}
                >
